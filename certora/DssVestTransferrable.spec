...
methods {
    ...
    function czar() external returns (address) envfree;
...
rule vest(uint256 _id) {
    ...
    mathint czarBalanceBefore = dai.balanceOf(_czar);
    mathint usrBalanceBefore = dai.balanceOf(usr);
    ...
    mathint czarBalanceAfter = dai.balanceOf(_czar);
    mathint usrBalanceAfter = dai.balanceOf(usr);
