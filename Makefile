...
certora-transferable :; certoraRun --solc ~/.solc-select/artifacts/solc-0.6.12 src/DssVest.sol:DssVestTransferrable src/specs/Dai.sol --link DssVestTransferrable:gem=Dai --verify DssVestTransferrable:src/specs/DssVestTransferrable.spec --rule_sanity
